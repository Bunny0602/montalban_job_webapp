...
const Sidebar = ({ active, setActive, onLogout }) => {
  ...
  useEffect(() => {
    const onResize = () => setIsMobile(window.innerWidth < 768); // match admin: 768px
    onResize();
  ...
  return (
    <>
      ...
      <aside
        className={`jobseeker-sidebar ${isMobile && mobileOpen ? "mobile-open" : ""}`}
